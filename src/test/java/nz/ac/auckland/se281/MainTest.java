...
public class MainTest {
  ...
  public static class Task2 extends CliTest {
    ...
    @Test
    public void T2_08_02_make_booking_for_past_month() throws Exception {
      runCommands(
          unpack(
              CREATE_TEN_VENUES,
              SET_DATE,
              "03/02/2024", //
              MAKE_BOOKING,
              options("GGG", "03/01/2024", "client001@email.com", "230")));

      assertContains("Booking not made: '03/01/2024' is in the past (system date is 03/02/2024).");
      assertDoesNotContain("Successfully created booking 'HUD14D8O'", true);
    }

    @Test
    public void T2_08_03_make_booking_for_past_day() throws Exception {
      runCommands(
          unpack(
              CREATE_TEN_VENUES,
              SET_DATE,
              "03/02/2024", //
              MAKE_BOOKING,
              options("GGG", "02/02/2023", "client001@email.com", "230")));

      assertContains("Booking not made: '02/02/2023' is in the past (system date is 03/02/2024).");
      assertDoesNotContain("Successfully created booking 'HUD14D8O'", true);
    }
    ...
    @Test
    public void T2_11_01_booking_next_available_date_after_making_far_bookings() throws Exception {
      runCommands(
          unpack(
              CREATE_TEN_VENUES, //
              SET_DATE,
    ...
    @Test
    public void T2_11_02_booking_next_available_date_after_making_gap_bookings() throws Exception {
      runCommands(
          unpack(
              CREATE_TEN_VENUES, //
              SET_DATE,
